...
public class DayRuleElementAnalyzerTest {
    @Test
    public void testDayExprParse() {
        ...
        exprText = "(M01d01 && !E6 && !E7) && (1 + 3 == 4) && (1 + 3 >= 4) && true || (M01d01(1, 2) && E1)";
        analyze(10, exprText);
        ...
        exprText = "12-25,12-28; (m12d25 && !e6 & !e7) | (m12d26 && !e6 && !e7) & GoodFriday(-1,-2,-4) & W2E1M10(-1,-2,-4) | M12D26E6(2) |  W3E1Y(-1,-2,-4) & m12d25e6(2) | m12d26e7(2) | m12d25e7(2,-4,-5,-6,-7,-8,-10) WHO I AM";
    ...
    private void analyze(int index, String exprText) {
        System.out.println("///" + index + " Input: " + exprText);
        List<Element> elements = DayRuleElementAnalyzer.analyze(exprText);
